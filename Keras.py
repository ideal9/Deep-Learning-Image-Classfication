...
if Train == True:
    model.add(Convolution2D(64, 5, 5, activation='relu', input_shape=(1, 28, 28), dim_ordering='th'))
else:
    model.add(Convolution2D(64, 5, 5, activation='relu', input_shape=(3, 32, 32), dim_ordering='th'))
